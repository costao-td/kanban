...
export default function Editor({
  ...
  return (
    <div ref={containerRef}>
      ...
      <EditorContent
        editor={editor}
        className="p-4 border border-neutral-200 bg-neutral-50 rounded-md prose dark:prose-invert prose-sm max-w-none overflow-y-auto [&_blockquote]:!text-xs [&_h1]:!text-lg [&_h2]:!text-base [&_h3]:!text-sm [&_ol]:!text-xs [&_p.is-empty::before]:text-light-900 [&_p.is-empty::before]:dark:text-dark-800 [&_p]:!text-sm [&_p]:text-light-950 [&_p]:dark:text-dark-950 [&_ul]:!text-xs"
      />
    </div>
  );
}
